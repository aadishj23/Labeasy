...
const FIELDS = [
  ...
  { id: "OwnerName", label: "Owner name", placeholder: "Jane Doe" },
  { id: "Email", label: "Email", type: "email", placeholder: "lab@example.com" },
  { id: "Phone", label: "Phone", type: "tel", placeholder: "10-digit number" },
  { id: "LicenseNo", label: "License no.", placeholder: "License number" },
  { id: "GSTNo", label: "GST no.", placeholder: "GST number" },
  { id: "Address", label: "Address", placeholder: "Street address", full: true },
  { id: "City", label: "City", placeholder: "City" },
  { id: "State", label: "State", placeholder: "State" },
  { id: "Pincode", label: "Pincode", placeholder: "Pincode" },
];
...
function SignupLab() {
  ...
  return (
    <AuthShell
      ...
      subtitle="List your tests and reach more patients."
      footer={
        <>
          Already have an account?{" "}
          <Link href="/signinlab" className="font-medium text-primary hover:underline">
            Sign in
          </Link>
        </>
      }
